...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'armbot_move' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/e/ROS/Armbot/install_isolated/lib;/home/e/ROS/Armbot/devel_isolated/armbot_description/lib;/home/e/ROS/Armbot/devel/lib;/home/e/ws_moveit/devel/lib;/opt/ros/melodic/lib)
